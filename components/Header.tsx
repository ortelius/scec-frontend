        ...
        <div className="flex items-center h-16">
          <Link href="/" className="flex items-center gap-2 cursor-pointer mr-8">
            ...
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115.36 109.69" className="h-10 w-auto">
              <defs>
                <style>
                  {`.cls-1{fill:#3dff47;}.cls-2{fill:#636363;}.cls-3{isolation:isolate;}.cls-4{fill:none;stroke:#000;stroke-miterlimit:10;}`}
                </style>
              </defs>
              <title>OrteliusLogo</title>
              <path className="cls-1" d="M96.32,39.41c0,19.17-15.83,44.43-34.52,53.82a6.83,6.83,0,0,1-7.12-.06c-16.27-8.62-34.6-34.85-34.6-53.76,0-20.76,17.06-37.58,38.12-37.58S96.32,18.7,96.32,39.41Z" transform="translate(-0.7 0.02)"/>
              ...
              <g className="cls-3"><g className="cls-3"><path className="cls-1" d="M16.08,105.87a3.07,3.07,0,0,1-3.35,3.3H4.57a3.15,3.15,0,0,1-3.37-3.3v-4.46a3.31,3.31,0,0,1,3.38-3.14h8.15a3.14,3.14,0,0,1,3.35,3.46ZM13.33,102c0-.45,0-.91-.6-.91H4.57c-.64,0-.64.35-.64.71v3.62c0,.53.07.91.63.91H12.7c.63,0,.63-.36.63-.76Z" transform="translate(-0.7 0.02)"/></g><g className="cls-3"><path className="cls-4" d="M16.08,105.87a3.07,3.07,0,0,1-3.35,3.3H4.57a3.15,3.15,0,0,1-3.37-3.3v-4.46a3.31,3.31,0,0,1,3.38-3.14h8.15a3.14,3.14,0,0,1,3.35,3.46ZM13.33,102c0-.45,0-.91-.6-.91H4.57c-.64,0-.64.35-.64.71v3.62c0,.53.07.91.63.91H12.7c.63,0,.63-.36.63-.76Z" transform="translate(-0.7 0.02)"/></g><g className="cls-3"><path className="cls-1" d="M17.43,98.29H29.5c2.66,0,2.66.85,2.66,3.44a2.34,2.34,0,0,1-.6,1.9c.3.46.7.72.7,1.48l.5,4.06H30l-.47-4.06H20.19v4.06H17.42Zm2.76,4.08h8.68c.5,0,.63-.64.63-1.3H20.19Z" transform="translate(-0.7 0.02)"/></g><g className="cls-3"><path className="cls-4" d="M17.43,98.29H29.5c2.66,0,2.66.85,2.66,3.44a2.34,2.34,0,0,1-.6,1.9c.3.46.7.72.7,1.48l.5,4.06H30l-.47-4.06H20.19v4.06H17.42Zm2.76,4.08h8.68c.5,0,.63-.64.63-1.3H20.19Z" transform="translate(-0.7 0.02)"/></g><g className="cls-3"><path className="cls-1" d="M33.62,98.29h15v2.78H42.46v8.1H39.8V101.1H33.62Z" transform="translate(-0.7 0.02)"/><path className="cls-1" d="M64.68,98.27v2.8H53.27c-.58,0-.65.44-.65.91v.36H64.68v2.81h-12v.25c0,.53.07.93.63.93H64.68v2.84H53.27a3.24,3.24,0,0,1-3.39-3.46v-3.95a3.38,3.38,0,0,1,3.39-3.47Z" transform="translate(-0.7 0.02)"/><path className="cls-1" d="M77.34,106.31v2.86H69.2a3.15,3.15,0,0,1-3.37-3.3v-7.6h2.73v7.13c0,.53.07.91.63.91Z" transform="translate(-0.7 0.02)"/><path className="cls-1" d="M81.67,98.27v10.9h-3V98.27Z" transform="translate(-0.7 0.02)"/><path className="cls-1" d="M95.33,98.27h2.74v7.6a3.07,3.07,0,0,1-3.35,3.3H86.56a3.15,3.15,0,0,1-3.37-3.3v-7.6h2.73v7.13c0,.53.07.91.63.91h8.14c.63,0,.63-.36.63-.76Z" transform="translate(-0.7 0.02)"/><path className="cls-1" d="M112,102.38c3.11,0,3.58,1.49,3.58,3.45s-.5,3.34-3.55,3.34h-12v-2.72H112c.86,0,.87-.58.89-1.3H103c-3,0-3.6-1.41-3.6-3.39s.32-3.47,3.6-3.47h11.87v2.77H102.27c0,.57,0,1.32.71,1.32Z" transform="translate(-0.7 0.02)"/></g><g className="cls-3"><path className="cls-4" d="M33.62,98.29h15v2.78H42.46v8.1H39.8V101.1H33.62Z" transform="translate(-0.7 0.02)"/><path className="cls-4" d="M64.68,98.27v2.8H53.27c-.58,0-.65.44-.65.91v.36H64.68v2.81h-12v.25c0,.53.07.93.63.93H64.68v2.84H53.27a3.24,3.24,0,0,1-3.39-3.46v-3.95a3.38,3.38,0,0,1,3.39-3.47Z" transform="translate(-0.7 0.02)"/><path className="cls-4" d="M77.34,106.31v2.86H69.2a3.15,3.15,0,0,1-3.37-3.3v-7.6h2.73v7.13c0,.53.07.91.63.91Z" transform="translate(-0.7 0.02)"/><path className="cls-4" d="M81.67,98.27v10.9h-3V98.27Z" transform="translate(-0.7 0.02)"/><path className="cls-4" d="M95.33,98.27h2.74v7.6a3.07,3.07,0,0,1-3.35,3.3H86.56a3.15,3.15,0,0,1-3.37-3.3v-7.6h2.73v7.13c0,.53.07.91.63.91h8.14c.63,0,.63-.36.63-.76Z" transform="translate(-0.7 0.02)"/><path className="cls-4" d="M112,102.38c3.11,0,3.58,1.49,3.58,3.45s-.5,3.34-3.55,3.34h-12v-2.72H112c.86,0,.87-.58.89-1.3H103c-3,0-3.6-1.41-3.6-3.39s.32-3.47,3.6-3.47h11.87v2.77H102.27c0,.57,0,1.32.71,1.32Z" transform="translate(-0.7 0.02)"/></g></g>
            </svg>
            {/* --- END SVG LOGO --- */}
          </Link>
